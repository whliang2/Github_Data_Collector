...
class GetArchivedStatus:
    ...
    def get(self):
        ...
        try:
            if self.extract_values(response,'archived')[0] == "True":
                return 1
            else:
                return 0
        except:
        ...
        # return self.extract_values(response,'archived')[0]
...
# new_response = GetArchivedStatus("Tyrrrz", "DiscordChatExporter").get()
# print(new_response)
